...
class GuildStubs extends WiremockConfig {
    ...
    def stubGuildMembersResponse() {
        stubFor(
                get(urlEqualTo("/guild/4BBB52AA-D768-4FC6-8EDE-C299F2822F0F/members"))
                        .withHeader("Authorization", equalTo("Bearer 1234"))
                        .willReturn(okJson(parseResponseText("/responses/guild/members.json")))
        )
    }

    def stubGuildRanksResponse() {
        stubFor(
                get(urlEqualTo("/guild/4BBB52AA-D768-4FC6-8EDE-C299F2822F0F/ranks"))
                        .withHeader("Authorization", equalTo("Bearer 1234"))
                        .willReturn(okJson(parseResponseText("/responses/guild/ranks.json")))
        )
    }

    def stubGuildStashResponse() {
        stubFor(
                get(urlEqualTo("/guild/4BBB52AA-D768-4FC6-8EDE-C299F2822F0F/stash"))
                        .withHeader("Authorization", equalTo("Bearer 1234"))
                        .willReturn(okJson(parseResponseText("/responses/guild/stash.json")))
        )
    }

    def stubGuildTreasuryResponse() {
        stubFor(
                get(urlEqualTo("/guild/4BBB52AA-D768-4FC6-8EDE-C299F2822F0F/treasury"))
                        .withHeader("Authorization", equalTo("Bearer 1234"))
                        .willReturn(okJson(parseResponseText("/responses/guild/treasury.json")))
        )
    }

    def stubGuildTeamsResponse() {
        stubFor(
                get(urlEqualTo("/guild/4BBB52AA-D768-4FC6-8EDE-C299F2822F0F/teams"))
                        .withHeader("Authorization", equalTo("Bearer 1234"))
                        .willReturn(okJson(parseResponseText("/responses/guild/teams.json")))
        )
    }

    def stubGuildUpgradesResponse() {
        stubFor(
                get(urlEqualTo("/guild/4BBB52AA-D768-4FC6-8EDE-C299F2822F0F/upgrades"))
                        .withHeader("Authorization", equalTo("Bearer 1234"))
                        .willReturn(okJson(parseResponseText("/responses/guild/guild_upgrade_ids.json")))
        )
    }
}
