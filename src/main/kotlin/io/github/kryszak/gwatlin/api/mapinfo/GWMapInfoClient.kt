...
class GWMapInfoClient {
     ...
     */
    @JvmOverloads
    fun getMaps(mapIds: Collection<Int>, language: io.github.kryszak.gwatlin.api.ApiLanguage? = null) = mapInfoClient.getMaps(mapIds, language)
     ...
     */
    @JvmOverloads
    fun getMap(mapId: Int, language: io.github.kryszak.gwatlin.api.ApiLanguage? = null) = getMaps(listOf(mapId), language).firstOrNull()
     ...
     */
    @JvmOverloads
    fun getContinent(continentId: Int, language: io.github.kryszak.gwatlin.api.ApiLanguage? = null) =
     ...
     */
    @JvmOverloads
    fun getFloor(continentId: Int, floorId: Int, language: io.github.kryszak.gwatlin.api.ApiLanguage? = null) =
     ...
     */
    @JvmOverloads
    fun getRegion(continentId: Int, floorId: Int, regionId: Int, language: io.github.kryszak.gwatlin.api.ApiLanguage? = null) =
     ...
     */
    @JvmOverloads
    fun getMap(continentId: Int, floorId: Int, regionId: Int, mapId: Int, language: io.github.kryszak.gwatlin.api.ApiLanguage? = null) =
